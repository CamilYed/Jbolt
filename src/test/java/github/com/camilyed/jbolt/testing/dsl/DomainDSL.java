  ...
  public static class HttpResponseAssert extends AbstractAssert<HttpResponseAssert, HttpResponse> {
    ...
    public HttpResponseAssert isSuccessful() {
      ...
      if (!actual.isSuccessful()) {
        failWithMessage(
            "Expected response to be successful but status code was <%s>", actual.statusCode());
      }
      return this;
    }
    ...
    public HttpResponseAssert isNotSuccessful() {
      ...
      if (actual.isSuccessful()) {
        failWithMessage(
            "Expected response NOT to be successful but status code was <%s>", actual.statusCode());
      }
      return this;
    }
