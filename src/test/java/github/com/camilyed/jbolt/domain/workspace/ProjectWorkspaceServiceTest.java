...
class ProjectWorkspaceServiceTest {
  ...
  class ProjectTests {
    ...
    void shouldCreateProject() {
      ...
      // then
      assertThat(project).hasName(VALID_NAME).hasCollectionsCount(0);
    }
  ...
  class CollectionTests {
    ...
    void shouldAddFolder() {
      ...
      // then
      assertThat(updated).hasItemsCount(1).containsItem(FOLDER_NAME);
    }
    ...
    void shouldAddRequest() {
      ...
      // then
      assertThat(updated).hasItemsCount(1).containsItem(REQUEST_NAME);
    }
    ...
    void shouldMixItems() {
      ...
      // when
      final var updated =
          service.addRequestToCollection(collection, REQUEST_NAME, "POST", "/login");

      // then
      assertThat(updated).hasItemsCount(2).containsItem(FOLDER_NAME).containsItem(REQUEST_NAME);
    }
    ...
    void shouldValidateItemNames(final String invalidName) {
      ...
      assertThrows(
          IllegalArgumentException.class, () -> service.addFolderToCollection(col, invalidName));
      assertThrows(
          IllegalArgumentException.class,
          () -> service.addRequestToCollection(col, invalidName, "GET", "/"));
    }
  }
