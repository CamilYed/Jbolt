...
/**
 * Primary entry point for managing workspace domain logic.
 * Ensures all business invariants are met before structural changes.
 */
public final class ProjectService {
    ...
    public Collection addRequestToCollection(final Collection collection, final String name, final String method, final String url) {
        Objects.requireNonNull(collection);
        validateName(name);
    ...
    public Folder addRequestToFolder(final Folder folder, final String name, final String method, final String url) {
