...
/**
 * Domain model representing an immutable HTTP Response. Contains the result data returned from the
 * execution engine.
 *
...
public record HttpResponse(
    int statusCode, String body, Map<String, String> headers, long durationMillis) {
  /**
   * Checks if the response indicates a successful operation. Logic is based on the standard 2xx
