 ...
 * region from {@link #build()}. This keeps view construction type-safe, refactor-friendly, and
 * free of the loader/controller-factory indirection FXML requires.
 *
...
public interface Component<T extends Region> {
    ...
    /**
     * Builds and returns this component's root region. Implementations construct a fresh node
     * tree on every call; callers own the returned instance.
     */
    T build();
}
