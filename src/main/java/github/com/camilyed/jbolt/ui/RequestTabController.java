 ...
 * response panel. Purely a view - all state and behavior lives in the injected
 * {@link RequestTabViewModel}, which this class binds its controls to.
 */
